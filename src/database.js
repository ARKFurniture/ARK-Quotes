  ...
  const stmt = db.prepare(`
    INSERT INTO quotes
      (customer_name, customer_email, piece_type, finish, detail_rating, detail_reasoning,
       option1_label, option1_price, option2_label, option2_price, pickup_date, html_quote, status)
    VALUES
      (@customer_name, @customer_email, @piece_type, @finish, @detail_rating, @detail_reasoning,
       @option1_label, @option1_price, @option2_label, @option2_price, @pickup_date, @html_quote, 'pending')
  `);
